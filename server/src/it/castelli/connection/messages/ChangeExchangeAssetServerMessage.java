...
public class ChangeExchangeAssetServerMessage implements Message
{
    ...
    public void onReceive(Connection connection, Player player)
    {
        ...
        {
            connection.send(ServerMessages.ERROR_MESSAGE_NAME, Serializer.toJson(new ErrorServerMessage("L'altro giocatore ha già accettato, puoi solo accettare o rifiutare lo scambio!")));
        }
