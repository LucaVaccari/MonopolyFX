...
public class MortgageContractServerMessage implements Message
{
    ...
    public void onReceive(Connection connection, Player player)
    {
        ...
        {
            connection.send(ServerMessages.GENERIC_MESSAGE_NAME, Serializer.toJson(new GenericServerMessage("Operazione negata", "Non potete ipotecare questa proprieta', assicuratevi che non vi siano case o alberghi o che la proprieta' non sia gia' ipotecata!")));
        }
