	...
	public RandomEventManager()
	{
		chances.addAll(Arrays.asList(
				...
				new PayHousesRandomEvent(
						"Avete tutti i vostri stabili da riparare: " +
								"pagare 25 M per ogni casa e 100 M per ogni albergo", RandomEventType.CHANCE, 25, 100),
				new GoToRandomEvent(
				...
				new GoToRandomEvent(
						...
						24, true),
				new PayRandomEvent(
						"Matrimonio in famiglia: spese impreviste 150 M", RandomEventType.CHANCE, 150),
				new YouWonRandomEvent(
						"Maturano le cedole delle vostre cartelle di rendita, ritirate 150 M", RandomEventType.CHANCE,
						150),
				new PayHousesRandomEvent(
						"Dovete pagare un contributo di miglioria stradale, " +
								"40" +
								" M per ogni casa, " +
								"100 M per ogni albergo che possedete", RandomEventType.CHANCE, 40, 100),
				...
				new YouWonRandomEvent(
						...
						50),
				new PayRandomEvent("Versate 20 M per benificenza", RandomEventType.CHANCE, 20)
		));
		...
		communityChests.addAll(Arrays.asList(
				...
				new GoToRandomEvent(
						...
						30, false),
				new YouWonRandomEvent(
						"Avete venduto delle azioni: ricavate 50 M", RandomEventType.COMMUNITY_CHEST, 50),
				new YouWonRandomEvent(
						"Siete creditori verso la Banca di 200 M: ritiratele", RandomEventType.COMMUNITY_CHEST,
						200),
				...
				new YouWonRandomEvent(
						...
						25),
				new PayRandomEvent(
						"Scade il Vostro premio di assicurazione: pagate 50 M", RandomEventType.COMMUNITY_CHEST,
						50),
				new YouWonRandomEvent(
						"Avete vinto un premio di consolazione alla Lotteria" +
								" " +
								"di Merano, ritirate 100 M", RandomEventType.COMMUNITY_CHEST,
						100),
				new YouWonRandomEvent(
						"Avete vinto il secondo premio in un concorso di " +
								"bellezza: ritirate 10 M", RandomEventType.COMMUNITY_CHEST,
						10),
				new YouWonRandomEvent(
						"Rimborso tassa sul reddito: ritirate 20 M dalla " +
								"Banca", RandomEventType.COMMUNITY_CHEST,
						20),
				new PayRandomEvent("Avete perso una causa: pagate 100 M", RandomEventType.COMMUNITY_CHEST, 100)
		));
	}
