	...
	public RandomEventManager()
	{
		chances.addAll(Arrays.asList(
				...
				new YouWonRandomEvent(
						...
						150),
				new PayHousesRandomEvent(
						"Dovete pagare un contributo di miglioria stradale, 40" +
								" M per ogni casa, " +
				...
				new GoToRandomEvent("Andate fino al Parco della Vittoria", 39,
						false),
				new GoToRandomEvent(
						"Andate fino alla Via Accademia: se passate dal 'Via!'" +
								" ritirate 200 M",
						11, true),
		...
		communityChests.addAll(Arrays.asList(
				...
				new GoToRandomEvent("Andate avanti sino al 'Via!'", 0, true),
				new YouWonRandomEvent(
						"È maturata la cedola delle vostre azioni: ritirate 25" +
								" M",
						25),
				new PayRandomEvent(
